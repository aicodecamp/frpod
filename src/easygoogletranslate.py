    ...
    def translate(self, text, target_language='', source_language='', timeout=10):
        ...
        if type(target_language) is list:
            with concurrent.futures.ThreadPoolExecutor() as executor:
                ...
                return return_value
        #print( f' make request in target lang = {target_language}, source lang = {source_language}')
        result = self.make_request(target_language, source_language, text, timeout)
        return result
...
if __name__ =='__main__':
        ...
        result = translator.translate('bonjour monde')
        print(result)